...
from alterize.exceptions import ForceFail

from alterize.alter import rename_column, drop_column, add_column, rename_table
from alterize.alter import copy_table, replace_primary_key, name_primary_key
